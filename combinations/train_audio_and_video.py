...
from combinations.AudioAndVideoDataset import AudioAndVideoDataset
from combinations.AudioAndVideoModel import AudioAndVideoModel
from combinations._eval_model import _eval_model
from combinations._train_model import _train_model


def train_audio_and_video():
    dataset_type = AudioAndVideoDataset
    train_dataset = dataset_type(Config.train_path, Config.train_video_path)
    batch_size = min(Config.text_batch_size, Config.audio_batch_size)
    train_loader = DataLoader(train_dataset, batch_size=batch_size, shuffle=True)
    eval_dataset = dataset_type(Config.val_path, Config.val_video_path)
    eval_loader = DataLoader(eval_dataset, batch_size=batch_size)
    model = AudioAndVideoModel(
